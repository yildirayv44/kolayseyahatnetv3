      ...
      <div className="relative">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">İşlem Süresi</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">Başarı Oranı</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-slate-900">Uzman</div>
                <div className="text-xs text-slate-600">Danışmanlar</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">Destek</div>
              </div>
            </div>
          </div>
          ...
          <p className="text-sm text-slate-500">
            ⚡ <strong>Hızlı İşlem:</strong> Evraklarınız eksiksizse 48 saat içinde randevu
          </p>

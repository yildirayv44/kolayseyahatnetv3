...
const menuItems = [
  ...
  { href: "/admin/visa-matrix", label: "Vize Matrix", icon: Globe2, highlight: true },
  { href: "/admin/visa-matrix/logs", label: "Veri Çekme Logları", icon: FileText },
  { href: "/admin/visa-matrix/seo", label: "Vize SEO İçerik", icon: FileText },

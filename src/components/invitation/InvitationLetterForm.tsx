...
export function InvitationLetterForm({ locale }: Props) {
  ...
  const t = {
    tr: {
      ...
      next: "Devam",
      back: "Geri",
      generate: "Davetiye Oluştur",
      generating: "Oluşturuluyor...",
      copy: "Kopyala",
      copied: "Kopyalandı!",
      download: "İndir",
      newLetter: "Yeni Davetiye",
      error: "Bir hata oluştu. Lütfen tekrar deneyin.",
      usageBlocked: "Ücretsiz kullanım hakkınız dolmuştur. Daha fazla davetiye oluşturmak için lütfen üye olun.",
      register: "Üye Ol",
      requiredField: "Bu alan zorunludur",
      invalidDate: "Geçersiz tarih",
      endDateBeforeStart: "Bitiş tarihi başlangıç tarihinden önce olamaz",
      generatedLetter: "Oluşturulan Davetiye",
      editAndDownload: "Davetiyenizi inceleyip düzenleyebilir, ardından indirebilirsiniz.",
      outputLanguage: "Davetiye Dili",
      selectLanguage: "Dil Seçin",
      kvkkTitle: "KVKK Onayı",
      kvkkText: "Girdiğim bilgilerin davetiye oluşturmak için kullanılacağını ve Kolay Seyahat'in bu bilgileri kaydetmediğini, sadece kullanım istatistiklerini raporlama amacıyla tuttuğunu kabul ediyorum.",
      usageInfoTitle: "Ücretsiz Kullanım",
      usageInfoText: "Üye olmadan sadece 1 adet davetiye oluşturabilirsiniz. Sınırsız davetiye için üye olun.",
      ...
      websiteLink: "Bu davetiye https://www.kolayseyahat.net aracılığıyla oluşturulmuştur.",
    },
    en: {

...
export function VisaMap({ countries, onFilterChange }: Props) {
  ...
  const stats = [
    {
      ...
      tip: 'Sadece pasaportla gidebilirsiniz'
    },
    {
      ...
      tip: 'Havalimanında vize alabilirsiniz'
    },
    {
      status: 'eta',
      filterValue: 'E-vize',
      ...
      tip: 'Online başvuru ile 3-5 günde alınır'
    },
    {
      ...
      tip: 'Konsolosluk başvurusu gerekir'
    },
  ];
          ...
          <div className="flex gap-3">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-blue-50 px-3 py-2 border border-blue-200">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-blue-600">Kolay Seyahat</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {popularVisaFree.length > 0 && (
          <div className="border-t border-slate-100 pt-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-slate-700">Popüler Vizesiz Destinasyonlar</span>
            </div>
        ...
        <div className="mt-4 rounded-lg bg-slate-50 p-3 border border-slate-200">
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-slate-600">
              <strong className="text-slate-700">İpucu:</strong> Türk vatandaşları dünya ülkelerinin %{easyTravelPercentage}'ine vizesiz veya varışta vize ile seyahat edebilir. Kartlara tıklayarak ilgili ülkeleri filtreleyebilirsiniz.
            </p>
          </div>
        </div>
      </div>

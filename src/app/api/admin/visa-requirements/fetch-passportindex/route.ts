...
const TURKISH_PASSPORT_VISA_REQUIREMENTS: VisaRequirement[] = [
  // EUROPE - Schengen Countries (Visa-free - 90 days in 180 days)
  ...
  // EUROPE - Other Schengen
  { countryCode: 'LUX', countryName: 'Lüksemburg', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'SVK', countryName: 'Slovakya', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'SVN', countryName: 'Slovenya', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'EST', countryName: 'Estonya', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'LVA', countryName: 'Letonya', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'LTU', countryName: 'Litvanya', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'MLT', countryName: 'Malta', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'ISL', countryName: 'İzlanda', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },
  { countryCode: 'LIE', countryName: 'Lihtenştayn', visaStatus: 'visa-free', allowedStay: '90 days in 180 days', conditions: 'Schengen area', applicationMethod: 'not-required' },

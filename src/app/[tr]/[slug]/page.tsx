...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // Try to find blog with old URL pattern (without blog/ prefix)
  ...
  blog = getLocalizedFields(blog, 'tr');
...
export default async function LegacyBlogPage({ params }: PageProps) {
  ...
  // This route handles old blog URLs like /ingiltere-calisma-vizesi
  // Try to find the blog by the slug (without blog/ prefix)
  let blog = await getBlogBySlug(slug);

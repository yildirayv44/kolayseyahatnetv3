-- Migration: Add bilateral visa pages support to visa_pages_seo
-- Created: 2026-03-21
-- Purpose: Extend visa_pages_seo table for bilateral visa pages with slug-based URLs
...
-- Migration complete
-- New features:
-- - Slug-based URLs for bilateral visa pages
-- - Custom content support (AI + manual hybrid)
